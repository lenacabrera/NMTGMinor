...
def check_correctness_of_gender_terms(raw_path, ref, gender_set, f, sl, tl, pl):
    ...
    for tref, op_tref, gterms in zip(tref_file, op_tref_file, gterms_file):
        ...
        # # unede -> un, de
        # if "unede" in tref_list:
        #     i = tref_list.index("unede")
        #     tref_list = tref_list[:i] + ["une", "de"] + tref_list[i+1:]
        # if "unede" in op_tref_list:
        #     i = op_tref_list.index("unede")
        #     op_tref_list = op_tref_list[:i] + ["une", "de"] + op_tref_list[i+1:]
        # # un altra studentessa -> una
        # if "Un" in tref_list and "altra" in tref_list and "studentessa" in tref_list:
        #     tref_list[0] = "Una"
        # if "Un" in op_tref_list and "altra" in op_tref_list and "studentessa" in op_tref_list:
        #     op_tref_list[0] = "Una"
        # #
        # if "Parlando" in tref_list and "con" in tref_list and "un" in tref_list and "infermiera" in tref_list:
        #     i = tref_list.index("un")
        #     tref_list = tref_list[:i] + ["una"] + tref_list[i+1:]
        # if "Parlando" in op_tref_list and "con" in op_tref_list and "un" in op_tref_list and "infermiera" in op_tref_list:
        #     i = op_tref_list.index("un")
        #     op_tref_list = op_tref_list[:i] + ["una"] + op_tref_list[i+1:]
        # #
        # if "un" in tref_list and "assassina" in tref_list:
        #     i = tref_list.index("un")
        #     tref_list = tref_list[:i] + ["una"] + tref_list[i+1:]
        # if "un" in op_tref_list and "assassina" in op_tref_list:
        #     i = op_tref_list.index("un")
        #     op_tref_list = op_tref_list[:i] + ["una"] + op_tref_list[i+1:]
        # #
        # if "un" in tref_list and "Italoamericana" in tref_list:
        #     i = tref_list.index("un")
        #     tref_list = tref_list[:i] + ["una"] + tref_list[i+1:]
        # if "un" in op_tref_list and "Italoamericana" in op_tref_list:
        #     i = op_tref_list.index("un")
        #     op_tref_list = op_tref_list[:i] + ["una"] + op_tref_list[i+1:]
        # #
        # if "un" in tref_list and "esperta" in tref_list:
        #     i = tref_list.index("un")
        #     tref_list = tref_list[:i] + ["una"] + tref_list[i+1:]
        # if "un" in op_tref_list and "esperta" in op_tref_list:
        #     i = op_tref_list.index("un")
        #     op_tref_list = op_tref_list[:i] + ["una"] + op_tref_list[i+1:]
        # #
        # if "un" in tref_list and "entrata" in tref_list:
        #     i = tref_list.index("un")
        #     tref_list = tref_list[:i] + ["una"] + tref_list[i+1:]
        # if "un" in op_tref_list and "entrata" in op_tref_list:
        #     i = op_tref_list.index("un")
        #     op_tref_list = op_tref_list[:i] + ["una"] + op_tref_list[i+1:]
        # #
        # if "un" in tref_list and "adulta" in tref_list:
        #     i = tref_list.index("un")
        #     tref_list = tref_list[:i] + ["una"] + tref_list[i+1:]
        # if "un" in op_tref_list and "adulta" in op_tref_list:
        #     i = op_tref_list.index("un")
        #     op_tref_list = op_tref_list[:i] + ["una"] + op_tref_list[i+1:]
        # #
        # if "un" in tref_list and "avvocatessa" in tref_list:
        #     print("test1")
        #     i = tref_list.index("un")
        #     if tref_list[i+1] == "avvocatessa":
        #         tref_list = tref_list[:i] + ["una"] + tref_list[i+1:]
        #     else:
        #         for i_ in i:
        #             tref_list = tref_list[:i_] + ["una"] + tref_list[i_+1:]
        # if "un" in op_tref_list and "avvocatessa" in op_tref_list:
        #     print("test2")
        #     print(op_tref_list)
        #     i = op_tref_list.index("un")
        #     if op_tref_list[i+1] == "avvocatessa":
        #         for i_ in i:
        #             op_tref_list = op_tref_list[:i_] + ["una"] + op_tref_list[i_+1:]
        #     else:
        #         op_tref_list = op_tref_list[:i] + ["una"] + op_tref_list[i+1:]
