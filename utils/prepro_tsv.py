...
def extract_from_tsv(data_dir_path):
    ...
    c_ref_dir = "prep/correct_ref/"
    w_ref_dir = "prep/wrong_ref/"
    ...
    if "PAR" in mode.name:
        with open(os.path.join(file_path, "tsv/", "MULTILINGUAL_v1.2.tsv"), encoding='utf-8') as csv_file:
            ...
            par_es_c = open(os.path.join(file_path, c_ref_dir, "es_par.s"), "w", encoding='utf-8')
            par_it_c = open(os.path.join(file_path, c_ref_dir, "it_par.s"), "w", encoding='utf-8')
            par_fr_c = open(os.path.join(file_path, c_ref_dir, "fr_par.s"), "w", encoding='utf-8')
            par_en_c = open(os.path.join(file_path, c_ref_dir, "en_par.s"), "w", encoding='utf-8')

            par_es_w = open(os.path.join(file_path, w_ref_dir, "es_par.s"), "w", encoding='utf-8')
            par_it_w = open(os.path.join(file_path, w_ref_dir, "it_par.s"), "w", encoding='utf-8')
            par_fr_w = open(os.path.join(file_path, w_ref_dir, "fr_par.s"), "w", encoding='utf-8')
            par_en_w = open(os.path.join(file_path, w_ref_dir, "en_par.s"), "w", encoding='utf-8')
